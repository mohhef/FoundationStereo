...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vitl', features=256, out_channels=[256, 512, 1024, 1024], use_bn=False, use_clstoken=False, pretrained_dino=False):
        ...
        # Prefer a local torch.hub cache to avoid repeated network validation calls.
        local_dinov2 = os.path.expanduser("~/.cache/torch/hub/facebookresearch_dinov2_main")
        model_name = 'dinov2_{:}14'.format(encoder)
        if os.path.isdir(local_dinov2):
